...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { completed_date: @certification.completed_date, expiration_date: @certification.expiration_date, instructor_name: @certification.instructor_name, issuer: @certification.issuer, type: @certification.type, user_id: @certification.user_id }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { completed_date: @certification.completed_date, expiration_date: @certification.expiration_date, instructor_name: @certification.instructor_name, issuer: @certification.issuer, type: @certification.type, user_id: @certification.user_id }
    assert_redirected_to certification_path(assigns(:certification))
  end
